// LEGACY — archived 2026-05-07 when /playbook was repurposed as an
// email gate for the new interactive playbook at /playbook/access
// (feature/playbook-interactive). This file is intentionally not
// imported anywhere; it exists so the previous PDF-download flow is
// preserved verbatim and easy to diff without spelunking through
// git history.
//
// Behavior captured here:
// - Submitted email to formspree.io/f/movklzvl with subject
//   "New playbook download request from Found For AI"
// - Fired trackEvent("download_playbook", {...PDF filename...})
// - Redirected to /playbook/thanks on success
// - Schema graph included a DigitalDocument referencing
//   /found-for-ai-readability-playbook.pdf
